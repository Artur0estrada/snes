...
while True:
    ...
    if Keys[pygame.K_v]: screen.blit(crosshair, (220, 120))
    if Keys[pygame.K_z]: screen.blit(crosshair, (200, 140))

    if Keys[pygame.K_k]: screen.blit(crosshair, (220, 65))
    if Keys[pygame.K_l]: screen.blit(crosshair, (30, 65))
    if Keys[pygame.K_j]: screen.blit(crosshair, (130, 125))
    if Keys[pygame.K_i]: screen.blit(crosshair, (100, 125))
